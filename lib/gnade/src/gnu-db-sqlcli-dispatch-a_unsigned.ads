...
--                                                                           --
-------------------------------------------------------------------------------
with GNU.DB.SQLCLI.Generic_Attr.Unsigned_Attribute;
pragma Elaborate_All (GNU.DB.SQLCLI.Generic_Attr.Unsigned_Attribute);

generic
   type Mod_Type is mod <>;
package GNU.DB.SQLCLI.Dispatch.A_Unsigned is

   package Derived is new Attr.Unsigned_Attribute (Mod_Type);
   subtype Info is Derived.Attribute_Value_Pair_Unsigned;
