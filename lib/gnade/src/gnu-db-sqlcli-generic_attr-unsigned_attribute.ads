...
package GNU.DB.SQLCLI.Generic_Attr.Unsigned_Attribute is

   type Attribute_Value_Pair_Unsigned is new Attribute_Value_Pair
     with
      record
         Value : Mod_Type;
      end record;
   ...
   function GetAttr (Handle    : Context;
                    ...
                    return Attribute_Value_Pair_Unsigned;
