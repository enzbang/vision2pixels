...
-------------------------------------------------------------------------------
generic
package GNU.DB.SQLCLI.Generic_Attr.Context_Attribute is

   type Attribute_Value_Pair_Context
   is new Attribute_Value_Pair with
      record
         Value : aliased Context;
      end record;

   function To_String (Object : Attribute_Value_Pair_Context) return String;
   ...
   function GetAttr (Handle    : Context;
                    ...
                    return Attribute_Value_Pair_Context;
