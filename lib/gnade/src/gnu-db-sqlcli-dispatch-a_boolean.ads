...
--                                                                           --
-------------------------------------------------------------------------------
with GNU.DB.SQLCLI.Generic_Attr.Boolean_Attribute;
pragma Elaborate_All (GNU.DB.SQLCLI.Generic_Attr.Boolean_Attribute);

generic
   type Bool_Type is mod <>;
package GNU.DB.SQLCLI.Dispatch.A_Boolean is

   package Derived is new Attr.Boolean_Attribute (Bool_Type);
   subtype Info is Derived.Attribute_Value_Pair_Boolean_Scalar;
...
end GNU.DB.SQLCLI.Dispatch.A_Boolean;
