...
--                                                                           --
-------------------------------------------------------------------------------
with GNU.DB.SQLCLI.Generic_Attr.Wide_String_Attribute;
pragma Elaborate_All (GNU.DB.SQLCLI.Generic_Attr.Wide_String_Attribute);

generic
package GNU.DB.SQLCLI.Dispatch.A_Wide_String is

   package Derived is new Attr.Wide_String_Attribute;
   subtype Info is Derived.Attribute_Value_Pair_Wide_String;
...
end GNU.DB.SQLCLI.Dispatch.A_Wide_String;
