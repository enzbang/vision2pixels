...
package GNU.DB.SQLCLI.Generic_Attr.Pointer_Attribute is

   type Attribute_Value_Pair_Pointer is new Attribute_Value_Pair
     with
      record
         Value : aliased P_Object;
      end record;

   function To_String (Object : Attribute_Value_Pair_Pointer) return String;
