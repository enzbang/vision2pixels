...
package GNU.DB.SQLCLI.Generic_Attr.Bitmap_Attribute is

   type Attribute_Value_Pair_Bitmap is new Attribute_Value_Pair with
      record
         Value : E_Bitmap;
      end record;

   function To_String (Object : Attribute_Value_Pair_Bitmap) return String;
   ...
   function GetAttr (Handle    : Context;
                    ...
                    return Attribute_Value_Pair_Bitmap;
