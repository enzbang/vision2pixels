...
generic
   ...
   E_Name : String;
package GNU.DB.SQLCLI.Generic_Attr.Enumerated_Attribute is

   type Attribute_Value_Pair_Enum
   is new Attribute_Value_Pair with
      record
         Value : E;
      end record;

   function To_String (Object : Attribute_Value_Pair_Enum) return String;
   ...
   function GetAttr (Handle    : Context;
                    ...
                    return Attribute_Value_Pair_Enum;
...
private
   Default_Len : constant Base := Base (Length_Indicator (E_Base'Size));
