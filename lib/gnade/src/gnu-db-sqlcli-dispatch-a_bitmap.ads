...
--                                                                           --
-------------------------------------------------------------------------------
with GNU.DB.SQLCLI.Generic_Attr.Bitmap_Attribute;
pragma Elaborate_All (GNU.DB.SQLCLI.Generic_Attr.Bitmap_Attribute);

generic
   Default_Index : Attr.T;
   type E is (<>);
   type E_Bitmap is array (E) of Boolean;
package GNU.DB.SQLCLI.Dispatch.A_Bitmap is

   package Derived is new Attr.Bitmap_Attribute (E, E_Bitmap);
   subtype Info is Derived.Attribute_Value_Pair_Bitmap;
