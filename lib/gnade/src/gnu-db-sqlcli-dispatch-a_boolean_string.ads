...
--                                                                           --
-------------------------------------------------------------------------------
with GNU.DB.SQLCLI.Generic_Attr.Boolean_String_Attribute;
pragma Elaborate_All (GNU.DB.SQLCLI.Generic_Attr.Boolean_String_Attribute);

generic
package GNU.DB.SQLCLI.Dispatch.A_Boolean_String is

   package Derived is new Attr.Boolean_String_Attribute;
   subtype Info is Derived.Attribute_Value_Pair_Boolean_String;
...
end GNU.DB.SQLCLI.Dispatch.A_Boolean_String;
