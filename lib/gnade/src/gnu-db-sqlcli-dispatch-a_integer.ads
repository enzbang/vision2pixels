...
pragma Elaborate_All (GNU.DB.SQLCLI.Generic_Attr.Integer_Attribute);

generic
   type Int_Type is range <>;
package GNU.DB.SQLCLI.Dispatch.A_Integer is

   package Derived is new Attr.Integer_Attribute (Int_Type);
   subtype Info is Derived.Attribute_Value_Pair_Int;
...
end GNU.DB.SQLCLI.Dispatch.A_Integer;
