...
-------------------------------------------------------------------------------
generic
package GNU.DB.SQLCLI.Generic_Attr.String_Attribute is

   type Attribute_Value_Pair_String (Len : Natural)
   is new Attribute_Value_Pair with
      record
         Value : String (1 .. Len);
      end record;
   function To_String (Object : Attribute_Value_Pair_String) return String;
