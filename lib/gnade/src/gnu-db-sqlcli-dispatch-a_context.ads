...
--                                                                           --
-------------------------------------------------------------------------------
with GNU.DB.SQLCLI.Generic_Attr.Context_Attribute;
pragma Elaborate_All (GNU.DB.SQLCLI.Generic_Attr.Context_Attribute);

generic
package GNU.DB.SQLCLI.Dispatch.A_Context is

   package Derived is new Attr.Context_Attribute;
   subtype Info is Derived.Attribute_Value_Pair_Context;
