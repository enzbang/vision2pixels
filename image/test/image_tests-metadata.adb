...
package body Image_Tests.Metadata is
   ...
   procedure Geo_Format (T : in out AUnit.Test_Cases.Test_Case'Class) is
      ...
      Geo_Lat   : Geo_Coordinate := Geo_Coordinate'Value ("48.864263");
      Geo_Long  : Geo_Coordinate := Geo_Coordinate'Value ("2.39806");
   ...
   begin
      ...
      Assert (Pos_Lat = Latitude'(48, 51, 51, N),
             ...
             & "Get : " & Image.Metadata.Geographic.Image (Pos_Lat));

      Get_Lat := To_Geo_Coordinate (Pos_Lat);

      Assert (Get_Lat - Geo_Lat < Geo_Coordinate'Small,
              "To_Geo_Coordinate error for 48° 51' 51'' N" &
             Image.Metadata.Geographic.Image (Pos_Lat));
      ...
      Assert (Get_Long - Geo_Long < Geo_Coordinate'Small,
      ...
      Geo_Long  := Geo_Coordinate'Value ("-87.728055");
      Geo_Lat   := Geo_Coordinate'Value ("-40.4461110");
